  ...
  <div class="container-fluid">
    ...
    <div class="row d-flex justify-content-center">
      ...
      <div class="col-lg-4 col-md-5 mb-4">
        <div class="card shadow-sm text-center" style="width: 100%;">
          <div class="icon-container mx-auto mt-3">
            <img src="/assets/dkv.jpg.jpg" class="card-icon" alt="Icon Kompetensi 1" width="25%">
          </div>
          <div class="card-body">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card shadow-sm text-center" style="width: 100%;">
          <div class="icon-container mx-auto mt-3">
            <img src="/assets/pplg.jpg.jpg" class="card-icon" alt="Icon Kompetensi 2" width="25%">
          </div>
          <div class="card-body">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card shadow-sm text-center" style="width: 100%;">
          <div class="icon-container mx-auto mt-3">
            <img src="/assets/tjkt.jpg.jpg" class="card-icon" alt="Icon Kompetensi 3" width="25%">
          </div>
          <div class="card-body">
       ...
       <div class="col-lg-4 col-md-6 mb-4">
        <div class="card shadow-sm text-center" style="width: 100%;">
          <div class="icon-container mx-auto mt-3">
            <img src="/assets/toi.jpg.jpg" class="card-icon" alt="Icon Kompetensi 3" width="25%">
          </div>
          <div class="card-body">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card shadow-sm text-center" style="width: 100%;">
          <div class="icon-container mx-auto mt-3">
            <img src="/assets/tbsm.jpg.jpg" class="card-icon" alt="Icon Kompetensi 3" width="25%">
          </div>
          <div class="card-body">
