    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        <p style="background-color: whitesmoke"class="rounded-3 p-1 m-3 text-secondary">
          <nuxt-link to="/kurikulum/kompetensi keahlian" class="text-decoration-none">Kurikulum</nuxt-link> / Kompetensi Keahlian
        </p>
      </div>
    </div>
      ...
      <div class="col-lg-3 col-md-6 mb-4">
        <div class="card shadow-sm text-center" style="width: 100%">
          ...
          <div class="card-body">
            ...
            <p class="card-text">
              Penjelasan singkat tentang kompetensi keahlian ini untuk
