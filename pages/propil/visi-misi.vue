      ...
      <div class="col-lg-12">
        ...
        <div class="col-lg-12">
          <p style="background-color: whitesmoke;" class="rounded-3 p-1 m-3 text-secondary">
            <nuxt-link to="/propil" class="text-decoration-none">Profil</nuxt-link>/ Visi & Misi
          </p>
        </div>
        <div class="visimisi subcontent">
                ...
                <p style="margin-top:40px;">
                <p class="text-center"><q><strong>TERWUJUDNYA LULUSAN YANG CERDAS, AKTIF, KOMPETITIF, ADAPTIF, DAN PRODUKTIF BERLANDASKAN IMAN DAN TAKWA</strong></q></p>
                <p class="text-center"><q><strong>(CAKAP BERIMTAK)</strong></q></p>
                </p>
                <p style="margin-top:40px;">
